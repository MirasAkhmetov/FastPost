...
class LocaleManager(val context: Context?) {
    ...
    private val prefs: SharedPreferences? =
        context?.getSharedPreferences("com.project.fastpost-preferences", ContextWrapper.MODE_PRIVATE)

    val language: String?
        get() = prefs?.getString(LocalStorage.PREF_LANGUAGE, AppConstants.LANG_RU)
